...
2. From bmcctl repo:
   ```bash
   ./scripts/j4y-usb-init.sh /dev/sdX    # replace sdX — script asks confirm
   ```
3. Verify: `ls /run/media/$USER/J4Y-ROOT/START-HERE.txt`
4. Eject. You now have **Phase 0 complete**.

This stick can sit in a drawer until keys arrive. It contains **no secrets**.
